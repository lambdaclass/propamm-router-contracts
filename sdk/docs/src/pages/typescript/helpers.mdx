...
const minOut = applySlippage(amountOut, 50); // quote - 0.5% // [!code focus]
```
...
const deadline = deadlineIn(300); // now + 5 min // [!code focus]
```
...
parseUnits("1.5", 6);      // 1500000n // [!code focus]
formatUnits(1500000n, 6);  // "1.5" // [!code focus]
```

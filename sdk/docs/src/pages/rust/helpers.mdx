...
let min_out = apply_slippage(quote.amount_out, 50)?; // quote - 0.5% // [!code focus]
```
...
let deadline = deadline_in(300); // now + 5 min // [!code focus]
```
...
let router_address = parse_address("0x4DdF368080CD7946db5b459aD591c350158175e1")?; // [!code focus]
```
...
parse_units("1.5", 6)?;            // 1500000 // [!code focus]
format_units(1500000.into(), 6);   // "1.5" // [!code focus]
```
